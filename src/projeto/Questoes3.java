	...
	* Não calculamos o C1, C13, e C14 , porque qualquer número multiplicado por 0 = 0
	...
	É só multiplicar A, pelos valores que multiplicam as linhas de B...
		...
		+"                 | 2  0  x  3 |\n"
              ...
              +" Sabendo-se que det A = 81,podemos dizer que o valor de x²é:/n ";
        y.a="9";
        y.b="Número par";
        y.c="Maior que 100";
        y.d="Menor que 7";
        ...
        questao.add(y);
       //resposta D
	//Ao ultilizarmos a regra de Laplece, chegamos a equação 3x² = 81
	// Aplicamos Bhaskara onde Delta é igual a D = b²-4ac e logo após descobrimos o valor de X = -b +/- a raiz quadrada de 27. 
	// x² = menor que 7
