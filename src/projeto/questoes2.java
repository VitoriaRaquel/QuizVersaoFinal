...
x=9  
        ...
        w.enunciado = "- Considere a matriz S = "
                + " ( S11 S12  S13)" + " dada por Sij = {0, se i<j}" + "Então, resolva a inequação det S > 3x².\n"
                + " ( S21 S22  S23)                     {i+j, se i=j} ?\n"
                + " ( S31 S32  S33)                     {i-j, se i>j} \n";
        w.a = "3";
        w.b = "2";
        w.c = "-4< x >4";
        w.d = "2";
...
POSSUI UMA FILEIRA NULA, POR ISSO O DET É ZERO.
        ...
        |0   3 -4|0   3|               */
        w = new Questao();
        w.enunciado = "- Sabendo que A é uma matriz quadrada de ordem 3 e que o determinante de A é -2,"
                + "    calcule o valor do determinante da matriz 3A. \n";
        w.a = "-54";
        w.b = "-50";
        w.c = "-4";
        w.d = "-2";
